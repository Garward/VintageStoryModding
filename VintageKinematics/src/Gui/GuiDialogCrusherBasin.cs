...
namespace VintageKinematics.Gui
{
    ...
    public class GuiDialogCrusherBasin : GuiDialogBlockEntity
    {
        ...
        public GuiDialogCrusherBasin(string title, InventoryBase inventory, BlockPos pos, ICoreClientAPI capi)
        ...
        private void ComposeDialog(string title)
        {
            ...
            ElementBounds outputLabelBounds = ElementBounds.Fixed(slotPad, slotPad + 24.0 + inputSlotBounds.fixedHeight + 16.0, rowWidth, 22.0);
