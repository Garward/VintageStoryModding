...
{
    /// <summary>
    /// Shared shell for machines that own an openable inventory, regardless of where their
    /// work/progress is driven from.
    /// </summary>
    public abstract class BEOpenableInventoryMachineBase : BlockEntityOpenableContainer, IFaceMappedContainer
    {
        ...
        protected BEOpenableInventoryMachineBase(string inventoryClassName, int inventorySize, int inputSlot, int outputFirst, int outputLast)
            : this(inventoryClassName, inventorySize, inputSlot, inputSlot, outputFirst, outputLast)
        {
        }

        protected BEOpenableInventoryMachineBase(string inventoryClassName, int inventorySize, int inputFirst, int inputLast, int outputFirst, int outputLast)
            : this(inventoryClassName, inventorySize, inputFirst, inputLast, outputFirst, outputLast, null)
        {
        }

        protected BEOpenableInventoryMachineBase(
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            OnAfterInventoryInitialized(api);
        }

        protected virtual void OnAfterInventoryInitialized(ICoreAPI api) { }
