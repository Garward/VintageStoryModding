...
namespace VintageKinematics.Blocks
{
    ...
    /// <c>axis=x</c>/<c>axis=z</c> variants are only used to orient automation faces.
    /// </summary>
    public class BlockKineticMixer : BlockAxisOriented
    {
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            BEKineticMixer be = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEKineticMixer;
