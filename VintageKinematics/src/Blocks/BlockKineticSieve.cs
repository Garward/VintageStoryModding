...
{
    public class BlockKineticSieve : Block, IPlacementPreviewProvider
    {
        ...
        public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
        {
            ...
            BEKineticSieve be = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BEKineticSieve;
