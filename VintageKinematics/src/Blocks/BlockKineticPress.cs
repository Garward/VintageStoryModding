...
{
    /// <summary>
    /// Extractor: shaft enters horizontally and drives a plate that descends onto the bed.
    /// Side variants follow the standard inline conveyor layout: shaft on N/S for the base
    /// shape, input from the left, solid output to the right or bottom.
    /// </summary>
    public class BlockKineticPress : Block, IPlacementPreviewProvider
    {
