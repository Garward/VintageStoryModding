...
{
    public class BlockTreadwheel : Block, IPlacementPreviewProvider
    {
        ...
        public override void OnLoaded(ICoreAPI api)
        {
            ...
            interactions = new[]
            {
                new WorldInteraction { ActionLangCode = "vintagekinematics:blockhelp-treadwheel-run" },
                new WorldInteraction { ActionLangCode = "vintagekinematics:blockhelp-treadwheel-run-reverse" }
            };
        }
